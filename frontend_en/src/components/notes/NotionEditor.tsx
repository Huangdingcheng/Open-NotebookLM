    ...
    <div className={`flex flex-col h-full bg-white w-full ${isFullScreen ? 'fixed inset-0 z-50' : ''}`}>
      <div className="flex items-center justify-between p-4 border-b sticky top-0 bg-white z-10">
        <div className="flex items-center gap-2">
          <button onClick={() => coverInputRef.current?.click()} className="p-2 hover:bg-gray-100 rounded group relative" title="Add Cover">
            <Image size={18} />
        ...
        <div className="flex gap-2">
          <button onClick={() => setIsFullScreen(!isFullScreen)} className="p-2 hover:bg-gray-100 rounded" title={isFullScreen ? "Exit Full Screen" : "Full Screen"}>
